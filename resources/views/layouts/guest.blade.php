...
<div class="min-h-screen flex flex-col sm:justify-center items-center py-6 px-4">
    ...
    <div class="w-full sm:max-w-md login-card px-6 py-8 overflow-hidden">
        ...
        <div class="footer-links">
            <a href="{{ route('login') }}" class="footer-link">ورود به سیستم</a>
            <a href="{{ route('register') }}" class="footer-link">ثبت نام</a>
            <a href="{{ route('password.request') }}" class="footer-link">بازیابی رمزعبور</a>
        </div>
    </div>
